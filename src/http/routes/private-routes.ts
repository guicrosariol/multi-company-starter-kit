...
import { acceptInviteToCompanyController } from "../controllers/accept-invite-to-company";
...
export function privateRoutes(app: FastifyInstance) {
  ...
  app.post('/company/invite/accept', { onRequest: [verifyJwt] }, acceptInviteToCompanyController)
}